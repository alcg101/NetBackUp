...
def ssh_connection(ip):
    ...
    try:
        ...
        print(str(router_output) + "\n") #this should not be commented if I'm not saving the config file

        #this is to save the output of the command to a new file, comment if not saving the output
        #with open("/home/achevez/Escritorio/python/App1/NetworkApp/test_backup/config_" + ip.rstrip("\n") + ".txt", "w") as f:
            #print(str(router_output), file = f)
